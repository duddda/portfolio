      ...
      <ContainerContact>        
        ...
        <ContactContent>
          ...
          <div className="contact-content">
            ...
            <Link href="mailto:eduardatenorio-@hotmail.com">
              <a target="_blank">
                <span>eduardatenorio-@hotmail.com</span>
              </a>
            </Link>
          </div>
        ...
        <Form
          action="https://formsubmit.co/eduardatenorio-@hotmail.com"
          method="POST"
        >
